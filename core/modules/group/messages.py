...
choose_institute = (
    "Пожалуйста, выберите институт из предложенных вариантов. Также вы можете ввести название группы сразу."
    "\n\n"
    "Пример: рпс, рпс-31, рпс 31, 4б09"
)
choose_course = "Пожалуйста, выберите курс из предложенных вариантов."
choose_group = "Пожалуйста, выберите группу из предложенных вариантов. Также вы можете ввести название группы вручную.\n\nПример: рпс, рпс-31, рпс 31, 4б09"
choose_subgroup = "Пожалуйста, выберите номер подгруппы из предложенных вариантов."
